             ...
             <View style={[styles.flex1]}>
                 ...
                 <View style={[styles.flex1]}>
                     ...
                     <ViewPagerAndroid
                         ...
                         <View style={{flex: 1}} key="HomeView">
                         ...
                         <View style={{flex: 1}} key="CategoriesView">
                             <CategoryView navigate={navigate} ></CategoryView>

                         </View>

                         <View style={{flex: 1}} key="AllView">
                             <Text>all</Text>
                         </View>

                         <View style={{flex: 1}} key="FavoriteView">
                             <Text>favorite</Text>
                         </View>
                     </ViewPagerAndroid>
